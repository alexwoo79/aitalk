export default {
  ...
  upload: {
    ...
    mainTable: '主表',
    removeTable: '移除表',
    doubleClickToRename: '双击可修改表名称',
    renameHint: '双击表名可重命名',
    tabPreview: '📊 数据预览',
    tabRelation: '🔗 表关联',
    relationTitle: '表间关联', relationGraph: '关联拓扑图', relationDesc: '建立表与表之间的关联关系，实现跨表分析',
    ...
    newRelation: '新建关联',
    suggestedJoins: '推荐关联',
    suggestionDesc: '基于字段类型、名称相似度和数据分布智能推荐',
    smartRecommend: '智能推荐',
    suggestionHelp: '查看推荐说明',
    highConfidence: '高置信度',
    mediumConfidence: '中置信度',
    lowConfidence: '低置信度',
    viewPreview: '查看预览',
    showMoreSuggestions: '查看更多推荐',
    relationPreview: '关联预览',
    showFieldDetails: '显示字段详情',
    relationDetails: '关联详情',
    joinField: '关联字段',
    joinType: '关联类型',
    dataPreview: '数据预览',
    matchRate: '匹配率',
    relationDetailDesc: '关联说明',
    primaryKeyMatch: '基于主键精确匹配',
    previewJoinData: '预览关联数据（前 50 行）',
    tablesCount: '{n} 张表',
    relationsCount: '{n} 条关联',
    leftTable: '左表',
    rightTable: '右表',
    leftColumn: '左表字段',
    rightColumn: '右表字段',
    ...
    previewResult: '预览结果',
    // 关联卡片优化
    definedRelations: '已定义的关联',
    mainTableBadge: '主表',
    dimTableBadge: '维度表',
    keyFields: '关联字段',
    relationQuality: '关联质量',
    leftNullRate: '左表空值率',
    rightNullRate: '右表空值率',
    totalRows: '总行数',
    // 合并表列定义
    ...
    // URL 导入
    urlTitle: '从 URL 导入',
    urlPlaceholder: '输入 URL 或本地路径（http/https/file:// 或 /path/to/file.csv）...',
    urlLocalHint: '💡 支持本地绝对路径：Mac 如 /Users/xxx/data.csv，Windows 如 C:\\data\\file.csv 或 file:///C:/data/file.csv',
  ...
  config: {
    ...
    previewTablet: '平板端',
    previewMobile: '移动端',
    unsavedWarning: '部分配置尚未保存，预览数据可能与最终结果不一致',
    autoSave: '自动保存',
    lastSaved: '上次保存',
    filters: '筛选项',
    ...
    colExpr: '公式',
    unnamedCol: '未命名列',
    colExprPlaceholder: '如 A + B，点击上方按钮快速输入',
    compColNameHint: '计算列名称不要用纯数字格式，建议使用有意义的名称',
    insertCol: '插入 {{col}}',
    showInTable: '显示在表格中',
    computedColHelp: '点击下方列名插入 {{列名}}，支持 + - * / ( )',
